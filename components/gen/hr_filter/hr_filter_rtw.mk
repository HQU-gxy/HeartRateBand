...
PRODUCT_NAME              = hr_filter
MAKEFILE                  = hr_filter_rtw.mk
MATLAB_ROOT               = /Volumes/External/Applications/MATLAB_R2023b.app
MATLAB_BIN                = /Volumes/External/Applications/MATLAB_R2023b.app/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/maca64
START_DIR                 = /Volumes/External/Code/matlab
...
INCLUDES_BUILDINFO = -I$(START_DIR)/codegen/lib/hr_filter -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=hr_filter
...
SRCS = $(START_DIR)/codegen/lib/hr_filter/HeartRateFilter.cpp $(START_DIR)/codegen/lib/hr_filter/BiquadFilter.cpp
...
OBJS = HeartRateFilter.o BiquadFilter.o
...
%.o : $(START_DIR)/codegen/lib/hr_filter/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/hr_filter/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/hr_filter/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/hr_filter/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/hr_filter/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
HeartRateFilter.o : $(START_DIR)/codegen/lib/hr_filter/HeartRateFilter.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


BiquadFilter.o : $(START_DIR)/codegen/lib/hr_filter/BiquadFilter.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
